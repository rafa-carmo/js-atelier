...
describe('<HobbieCard />', () => {
    it("should be render a component HobbieCard", () => {
        render(<HobbieCard title='Test' image={{url: "image.png", alt: "image teste"}} description='description test'/>)
    ...
    it("should be put the title in alt if not setted", () => {
        render(<HobbieCard title='Test' image={{url: "image.png"}} description='description test'/>)
